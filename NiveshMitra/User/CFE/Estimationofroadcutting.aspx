                        ...
                        <div class="card-body">
                            ...
                            <div class="bg-primary text-white p-2 rounded mb-3">
                             <strong class="text-dark">Applicant Details:</strong>
                                ...
                                <div class="col-md-4 form-group row align-items-center mb-2">
                                    <label class="col-sm-6 col-form-label text-sm-end">Email Id<span class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                           ...
                           <div class="col-md-4 form-group row align-items-center mb-2">
                            ...
                            <asp:ListItem Text="--Select--" Value="0" />
                                ...
                                <div class="col-md-4 form-group row align-items-center mb-2">
                                    <label class="col-sm-6 col-form-label text-sm-end">Chainges from (in Km  decimal value) <span class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control form-control-sm" AutoComplete="off" />
                                    </div>
                                </div>
                                <div class="col-md-4 form-group row align-items-center mb-2">
                                    <label class="col-sm-6 col-form-label text-sm-end">Chainges to (in Km  decimal value)<span class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                                 ...
                                 <div class="col-md-12">
                             <div class="bg-primary text-white p-2 rounded mb-3">
                                 <strong class="text-dark">Depth at which utility is proposed to be :</strong>
                             </div>
                         </div>

                                 <div class="col-md-4 form-group row align-items-center mb-2">
                         <label class="col-sm-6 col-form-label text-sm-end">Along the Road(Meter)<span class="text-danger">*</span></label>
                         <div class="col-sm-6">
                             <asp:TextBox ID="txtalondtheroad" runat="server" CssClass="form-control form-control-sm" AutoComplete="off" />
                         </div>
                     </div>

                               <div class="col-md-4 form-group row align-items-center mb-2">
                             <label class="col-sm-6 col-form-label text-sm-end">Across the Road(Meter)<span class="text-danger">*</span></label>
                             <div class="col-sm-6">
                              <asp:TextBox ID="txtacrosstheroad" runat="server" CssClass="form-control form-control-sm" AutoComplete="off" />
                             </div>
                            </div>

                               <div class="col-md-12">
                            <div class="bg-primary text-white p-2 rounded mb-3">
                                <strong class="text-dark">Casing Details :</strong>
                            </div>
                            </div>
                                <div class="col-md-4 form-group row align-items-center mb-2">
                                <label class="col-sm-6 col-form-label text-sm-end">Is it proposed to lay the Utility across the road through casing pipe?<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    ...
                                    <asp:RadioButton ID="rbtnWetRiserNo" runat="server" GroupName="WetRiser" Text="No" />
                                       ...
                                       <div class="col-md-12">
                                        <div class="bg-primary text-white p-2 rounded mb-3">
                                          <strong class="text-dark">Inspection Chamber Details :</strong>
                                        </div>
                                        </div>

                                            <div class="col-md-4 form-group row align-items-center mb-2">
                                            <label class="col-sm-6 col-form-label text-sm-end">Are Inspection Chamber proposed at the end of Casing<span class="text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <asp:RadioButton ID="RadioButton1" runat="server" GroupName="WetRiser" Text="Yes" />
                                                <asp:RadioButton ID="RadioButton2" runat="server" GroupName="WetRiser" Text="No" />
                                            </div>
                                        </div>

                                    <div class="col-md-4 form-group row align-items-center mb-2">
                                    <label class="col-sm-6 col-form-label text-sm-end">Road cutting Restoration option<span class="text-danger">*</span></label>
                                     <div class="col-sm-6">
