    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div id="divText" runat="server">
                ...
                <%--changes--%>
                <div class="row" runat="server" id="divOffline">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divLandAllotment">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Industrial Land Allotment Registration </label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox1" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload1" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divNOCTreeFelling">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">NOC for Tree Felling </label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox2" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload2" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divDrawWater">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox3" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload3" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divAirWater">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Consent to Establish Under Air and Water Act(NOC)</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox4" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload4" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divRoadCutting">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">ROAD CUTTING FEE ESTIMATION</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox5" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload5" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divFire">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">NOC from Fire Department(prior to commencement of construction activities) or Provisional</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox6" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload6" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="Button6"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                                <asp:HyperLink ID="HyperLink6" runat="server" Target="_blank"></asp:HyperLink>
                                            </div>
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divPower">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Power Connection</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox7" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload7" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divLabour1996">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Registration under The Building and Other Construction Workers (Regulation of Employment and Conditions of Service) Act, 1996</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="TextBox8" runat="server" class="form-control" MaxLength="50" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                                <asp:FileUpload runat="server" ID="FileUpload8" Width="300px" Font-Italic="true" Height="45px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="Button8"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                                <asp:HyperLink ID="HyperLink8" runat="server" Target="_blank"></asp:HyperLink>
                                            </div>
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divPCB">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld1PCB" Text="Upload"  class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divHazPCB">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld2HazPCB" Text="Upload"  class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divSrvcCon">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld3SrvcCon"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divEleCon">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld4EleCon"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divFctryPlan">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld5FctryPlan" Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divDGsetNOC">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld6DGsetNOC"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divFireSfty">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld7FireSfty"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divRSDSLic">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld8RSDSLic"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divExplsvNOC">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld9ExplsvNOC" Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divPtrlNOC">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld10PtrlNOC"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divRdCtng">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld11RdCtng"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divNonEncmb">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld12NonEncmb"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divProfTax">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld13ProfTax"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divElcInsp">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld14ElcInsp"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divForstDist">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld15ForstDist"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divNonForstLand">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld16NonForstLand"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divIrrgNOC">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld17IrrgNOC"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divRevNOC">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld18RevNOC"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divGrndWtrNOC">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld19GrndWtrNOC" Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divNoWtrSplyCertfct">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld20NoWtrSply"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divPrmsntoDrawWtr">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld21ToDrawWtr"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divMunicipalWatr">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld22MunicipalWatr"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divUrbanWatr">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld23UrbanWatr"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divLbrAct1970">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld25LbrAct1970"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divLbrAct1979">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld26LbrAct1979"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divLbrAct1996">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld27LbrAct1996" Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divContrLbrAct">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Proposed Building Plan under The Factories Act 1948</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 d-flex">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld28ContrLbrAct"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                ...
                                <div class="col-md-12 d-flex" runat="server" visible="false" id="divContrLbrAct1979">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1 d-flex">
                                                <asp:Button runat="server" ID="btnUpld29ContrLbrAct1979"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                            </div>
                                            <div class="col-lg-1 d-flex">
                                    ...
                                    <div class="col-md-12 d-flex" runat="server" visible="false" id="divConstrPermit">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-1 d-flex">
                                                    <asp:Button runat="server" ID="btnUpld30ConstrPermit"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                                </div>
                                                <div class="col-lg-1 d-flex">
                                    ...
                                    <div class="col-md-12 d-flex" runat="server" visible="false" id="divBldngPlan">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-1 d-flex">
                                                    <asp:Button runat="server" ID="btnUpld31BldngPlan"  Text="Upload" class="btn btn-info btn-lg" Height="40px" Width="150px" />
                                                </div>
                                                <div class="col-lg-1 d-flex">
